...
#End Region
    ...
    Private Sub ConsultaMovimientoCaja(ByVal Caja As Byte,
    ...
    Private Function ConsultaMovimiento(ByVal Caja As Byte,
                                        ByVal FOperacion As Date,
                                        ByVal Consecutivo As Byte,
                                        ByVal Folio As Integer,
        ...
        Dim FiltroSeleccion As String = " WHERE Caja = " & Caja &
                                        " AND FOPeracion = " & strFOperacion &
        ...
        cmd.CommandText = "SET transaction isolation level read uncommitted SELECT * FROM vwConsultaCompensacionPorMovimientoCaja" & FiltroSeleccion
        da.Fill(dsDatosMov, "Compensacion")
    ...
    Private Sub Grid_Navigate(sender As Object, ne As NavigateEventArgs) Handles Grid.Navigate

    End Sub

    Private Sub mnuImpresion_Popup(sender As Object, e As EventArgs) Handles mnuImpresion.Popup
